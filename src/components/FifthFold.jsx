            ...
            <div className="faq-area">
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="author_one">
                    <div className="d-md-flex justify-content-md-start align-items-center text-md-start text-center">
                      <img 
                        src={instructor2}
                        className="img-fluid me-md-40 mb-md-0 mb-20 author-pic" 
                        alt="Nirmal Pant" 
                      />
                      <div className="author-del">
                        <h4 className="fs-24 mb-16">{InstructorData.name}</h4>
